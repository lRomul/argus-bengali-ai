...
class HierarchicalRecall(Metric):
    ...
    def reset(self):
        ...
        self.ekush_recall = Recall()

    def update(self, step_output: dict):
        grapheme_pred, vowel_pred, consonant_pred, ekush_pred = step_output['prediction']
        grapheme_target, vowel_target, consonant_target, ekush_target = step_output['target']
        ...
        self.ekush_recall.update(ekush_pred, ekush_target)
    ...
    def compute(self):
        ...
        ekush_score = self.ekush_recall.compute()
        return 0, 0, 0, ekush_score

    def epoch_complete(self, state, name_prefix=''):
        grapheme_score, vowel_score, consonant_score, ekush_score = self.compute()
        ...
        state.metrics[name_prefix + 'ekush_recall'] = ekush_score
